...
- **What:** SIX migrations are pending, apply **in order**:
  ...
  `20260624000000_public_group_leaderboard.sql` → `20260625000000_group_leaderboard_member_only.sql`.
  ...
  `list_public_group_leaderboard`; `20260625` RE-GATES it to **member-only** (the public group
  preview no longer shows a leaderboard — privacy). The new clients expect them. `20260616`/`20260617` build the Global feed +
