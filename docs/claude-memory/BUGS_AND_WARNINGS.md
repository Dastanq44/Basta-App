...
- **What:** SIX migrations are pending, apply **in order**:
  ...
  (DROP + recreate) with challenge/group context + can-open flags; `20260621` adds the creator-only
  `delete_challenge(uuid)` RPC. The new clients expect them. `20260616`/`20260617` build the Global feed +
